define([ "jquery", "underscore", "backbone", "application", "models", "text!tpl/announcement-list.html", "text!tpl/confirm.html", "text!tpl/file.html", "text!tpl/file-edit.html",
	...
	"text!tpl/user-edit.html", "text!tpl/user-list.html", "text!tpl/user-registration-select.html", "text!tpl/user-registration-success.html", "text!tpl/user-registration.html",
	"text!tpl/user-role-info.html", "text!tpl/user-search.html", "text!tpl/user-verification.html", "text!tpl/user.html", "text!tpl/language.html",
	"text!tpl/professor-committees.html", "text!tpl/professor-evaluations.html", "text!tpl/register.html", "text!tpl/institution-regulatory-framework.html",
	"text!tpl/institution-regulatory-framework-edit.html", "text!tpl/position-search-criteria.html", "text!tpl/position-search-result.html", "text!tpl/candidacy-edit.html",
	"text!tpl/candidate-candidacy-list.html", "text!tpl/candidacy.html", "text!tpl/candidacy-update-confirm.html", "text!tpl/institution-regulatory-framework-list.html",
	"text!tpl/register-members-edit.html", "text!tpl/register-members-edit-professor-list.html", "text!tpl/overlay.html", "text!tpl/position-main-edit.html",
	"text!tpl/position-candidacies-edit.html", "text!tpl/position-committee-edit.html", "text!tpl/position-committee-member-edit.html", "text!tpl/position-evaluation-edit.html",
	...
	function ($, _, Backbone, App, Models, tpl_announcement_list, tpl_confirm, tpl_file, tpl_file_edit, tpl_file_list, tpl_file_list_edit, tpl_home, tpl_login_admin,
		tpl_login_main, tpl_popup, tpl_professor_list, tpl_register_edit, tpl_register_list, tpl_role_edit, tpl_role_tabs, tpl_role, tpl_user_edit, tpl_user_list,
		tpl_user_registration_select, tpl_user_registration_success, tpl_user_registration, tpl_user_role_info, tpl_user_search, tpl_user_verification, tpl_user, tpl_language,
		tpl_professor_committees, tpl_professor_evaluations, tpl_register, tpl_institution_regulatory_framework, tpl_institution_regulatory_framework_edit,
		tpl_position_search_criteria, tpl_position_search_result, tpl_candidacy_edit, tpl_candidate_candidacy_list, tpl_candidacy, tpl_candidacy_update_confirm,
		tpl_institution_regulatory_framework_list, tpl_register_members_edit, tpl_register_members_edit_professor_list, tpl_overlay, tpl_position_main_edit,
		tpl_position_candidacies_edit, tpl_position_committee_edit, tpl_position_committee_member_edit, tpl_position_evaluation_edit,
		...
		Views.AdminMenuView = Views.BaseView.extend({
			...
			initialize: function () {
				_.bindAll(this, "render", "close", "closeInnerViews", "addFile", "addFileList", "addFileEdit",
					"addFileListEdit");
				this.model.bind('change', this.render);
			},
		...
		Views.LoginView = Views.BaseView.extend({
			...
			initialize: function () {
				_.bindAll(this, "render", "addFile", "addFileList", "addFileEdit", "addFileListEdit", "close",
					"closeInnerViews");
				_.bindAll(this, "showResetPassword", "showResendVerificationEmailForm", "resetPassword",
					"resendVerificationEmail", "login");
		...
		Views.UserRegistrationView = Views.BaseView.extend({
						...
						success: function (collection, resp) {
							collection.each(function (institution) {
								if (_.isObject(role.institution) && _.isEqual(institution.id, role.institution.id)) {
									...
									$("select[name='institution']",
										self.$el).append("<option value='" + institution.get("id") + "'>" + institution.get("name") + "</option>");
								}
							});
			...
			change: function (event, data) {
				var self = this;
				if ((data && _.isEqual(data.triggeredBy,
						...
						case "CANDIDATE":
							...
							files.fetch({
								...
								success: function (collection, response) {
									...
									self.addFile(collection, "BEBAIWSH_STRATIOTIKIS_THITIAS",
										self.$("#bebaiwsiStratiwtikisThitiasFile"), {
											withMetadata: false
										});
						...
						switch (field) {
							...
							case "fekSubject":
								return _.isEqual(self.model.get("status"),
									"UNAPPROVED") && self.model.has("fekSubject");
							case "subject":
				...
				switch (self.model.get("discriminator")) {
						...
						if (self.model.has("id")) {
							...
							files.fetch({
								...
								success: function (collection, response) {
									...
									self.addFileEdit(collection, "BEBAIWSH_STRATIOTIKIS_THITIAS",
										self.$("input[name=bebaiwsiStratiwtikisThitiasFile]"), {
											withMetadata: false,
											editable: self.isEditable("bebaiwsiStratiwtikisThitiasFile")
										});
									self.addFileEdit(collection, "FORMA_SYMMETOXIS",
										self.$("input[name=formaSymmetoxisFile]"), {
											withMetadata: false,
									...
									self.addFileListEdit(collection, "DIMOSIEYSI",
										self.$("input[name=dimosieusiFileList]"), {
											withMetadata: true,
					...
					case "PROFESSOR_DOMESTIC":
								...
								success: function (collection, resp) {
									...
									collection.filter(function (department) {
										return department.get('institution').id === selectedInstitution;
											...
											if (_.isObject(self.model.get("department")) && _.isEqual(department.id,
												self.model.get("department").id)) {
						...
						App.institutions.fetch({
							...
							success: function (collection, resp) {
								collection.each(function (institution) {
									if (_.isObject(self.model.get("institution")) && _.isEqual(institution.id,
										self.model.get("institution").id)) {
										$("select[name='institution']",
											self.$el).append("<option value='" + institution.get("id") + "' selected>" + institution.get("name") + "</option>");
									} else {
										$("select[name='institution']",
						...
						App.ranks.fetch({
							...
							success: function (collection, resp) {
								collection.each(function (rank) {
									if (_.isObject(self.model.get("rank")) && _.isEqual(rank.id,
										self.model.get("rank").id)) {
										$("select[name='rank']",
											self.$el).append("<option value='" + rank.get("id") + "' selected>" + rank.get("name") + "</option>");
									} else {
										$("select[name='rank']",
											self.$el).append("<option value='" + rank.get("id") + "'>" + rank.get("name") + "</option>");
									}
								});
				...
				self.collection.each(function (role) {
					if (role.get("status") === "UNVERIFIED") {
						data.announcements.push({
							text: $.i18n.prop('AnnouncementRoleStatus' + role.get("status"),
								$.i18n.prop(role.get('discriminator'))),
							url: "#profile"
						});
					}
				});
		...
		Views.MinistryAssistantListView = Views.BaseView.extend({
			...
			render: function (eventName) {
				...
				// Add Actions:
				self.$("#actions").html(
					"<div class=\"btn-group input-append\"><a id=\"createMinistryAssistant\" class=\"btn btn-small add-on\"><i class=\"icon-plus\"></i> " +
						$.i18n.prop('btn_create_ma') + " </a></div><div class=\"btn-group input-append\"></div>");
				return self;
			},
		...
		Views.PositionView = Views.BaseView.extend({
			...
			initialize: function () {
				_.bindAll(this, "render", "addFile", "addFileList", "addFileEdit", "addFileListEdit", "close",
					"closeInnerViews");
				_.bindAll(this, "renderCandidacies", "renderCommittee", "renderEvaluation", "renderNomination",
					"renderComplementaryDocuments");
		...
		Views.PositionEditView = Views.BaseView.extend({
			...
			initialize: function () {
				_.bindAll(this, "render", "addFile", "addFileList", "addFileEdit", "addFileListEdit", "close",
					"closeInnerViews");
				_.bindAll(this, "addPhase", "showTab", "showMainTab", "showCandidaciesTab", "showCommitteeTab",
					"showEvaluationTab", "showNominationTab", "showComplementaryDocumentsTab");
			...
			render: function (eventName) {
				...
				// Tabs:
				if (_.isEqual(self.model.get("phase").status, "ENTAGMENI") || _.isEqual(self.model.get("phase").status,
					"ANOIXTI")) {
		...
		Views.PositionMainEditView = Views.BaseView.extend({
			...
			isEditable: function (field) {
				var self = this;
				if (_.isEqual(self.model.get("phase").status, "ANAPOMPI") || _.isEqual(self.model.get("phase").status,
					"STELEXOMENI")) {
					return false;
				}
				switch (field) {
					// Fields
					case "name":
						return self.model.isNew() || _.isEqual(self.model.get("phase").status,
							"ENTAGMENI") || _.isEqual(self.model.get("phase").status, "ANOIXTI");
					case "department":
						return self.model.isNew() || _.isEqual(self.model.get("phase").status,
							"ENTAGMENI") || _.isEqual(self.model.get("phase").status, "ANOIXTI");
					case "description":
			...
			render: function (event) {
				...
				if (self.model.has("id")) {
					...
					files.fetch({
						cache: false,
						success: function (collection, response) {
							self.addFile(collection, "APOFASI_SYSTASIS_EPITROPIS",
								self.$("#apofasiSystasisEpitropisFileList"), {
									withMetadata: true
								});
							self.addFile(collection, "PRAKTIKO_SYNEDRIASIS_EPITROPIS_GIA_AKSIOLOGITES",
								self.$("#praktikoSynedriasisEpitropisGiaAksiologitesFile"), {
									withMetadata: true
								});
							self.addFile(collection, "AITIMA_EPITROPIS_PROS_AKSIOLOGITES",
								self.$("#aitimaEpitropisProsAksiologitesFile"), {
									withMetadata: true
								});
						}
					});
		...
		Views.PositionCommitteeEditView = Views.BaseView.extend({
			...
			initialize: function () {
				...
				_.bindAll(this, "render", "addFile", "addFileList", "addFileEdit", "addFileListEdit", "close",
					"closeInnerViews");
				_.bindAll(this, "change", "renderCommitteeMembers", "isEditable", "toggleRegisterMembers", "addMember",
					"removeMember", "submit", "cancel");
			...
			render: function (event) {
				...
				if (self.model.has("id")) {
					...
					files.fetch({
						cache: false,
						success: function (collection, response) {
							self.addFileEdit(collection, "APOFASI_SYSTASIS_EPITROPIS",
								self.$("input[name=apofasiSystasisEpitropisFileList]"), {
									withMetadata: true,
									editable: self.isEditable("apofasiSystasisEpitropisFileList")
								});
							self.addFileEdit(collection, "PRAKTIKO_SYNEDRIASIS_EPITROPIS_GIA_AKSIOLOGITES",
								self.$("input[name=praktikoSynedriasisEpitropisGiaAksiologitesFile]"), {
									withMetadata: true,
									editable: self.isEditable("praktikoSynedriasisEpitropisGiaAksiologitesFile")
								});
							self.addFileEdit(collection, "AITIMA_EPITROPIS_PROS_AKSIOLOGITES",
								self.$("input[name=aitimaEpitropisProsAksiologitesFile]"), {
									withMetadata: true,
			...
			render: function (event) {
				...
				_.each(self.model.get("evaluators"), function (evaluator) {
					...
					files.fetch({
						...
						reset: true,
						success: function (collection, response) {
							self.addFileList(collection, "AKSIOLOGISI",
								self.$("#positionEvaluatorFiles_" + positionEvaluator.get("position")).find("#aksiologisiFileList"),
								{
									withMetadata: true
								});
						}
		...
		Views.PositionEvaluationEditView = Views.BaseView.extend({
			...
			initialize: function () {
				...
				_.bindAll(this, "render", "addFile", "addFileList", "addFileEdit", "addFileListEdit", "close",
					"closeInnerViews");
				_.bindAll(this, "change", "renderEvaluators", "isEditable", "toggleRegisterMembers", "addMember",
					"removeMember", "submit", "cancel");
				...
				_.each(self.model.get("evaluators"), function (evaluator, index) {
					...
					if (evaluator.id) {
						...
						files.fetch({
							cache: false,
							success: function (collection, response) {
								self.addFileListEdit(collection, "AKSIOLOGISI",
									$el.find("input[name=aksiologisiFileList]"), {
										withMetadata: true,
		...
		Views.PositionNominationEditView = Views.BaseView.extend({
			...
			render: function (event) {
				...
				files.fetch({
					cache: false,
					success: function (collection, response) {
						self.addFileEdit(collection, "PROSKLISI_KOSMITORA",
							self.$("input[name=prosklisiKosmitoraFile]"), {
								withMetadata: true,
								editable: self.isEditable("prosklisiKosmitoraFile")
							});

						self.addFileListEdit(collection, "PRAKTIKO_EPILOGIS",
							self.$("input[name=praktikoEpilogisFile]"), {
								withMetadata: true,
								editable: self.isEditable("praktikoEpilogisFile")
							});
						self.addFileEdit(collection, "DIAVIVASTIKO_PRAKTIKOU",
							self.$("input[name=diavivastikoPraktikouFile]"), {
								withMetadata: true,
			...
			render: function (event) {
				...
				if (self.model.has("id")) {
					...
					files.fetch({
						cache: false,
						success: function (collection, response) {
							self.addFileListEdit(collection, "DIOIKITIKO_EGGRAFO",
								self.$("input[name=dioikitikoEggrafoFileList]"), {
									withMetadata: true,
		...
		Views.RegisterEditView = Views.BaseView.extend({
			...
			initialize: function () {
				...
				_.bindAll(this, "render", "addFile", "addFileList", "addFileEdit", "addFileListEdit", "close",
					"closeInnerViews");
				_.bindAll(this, "change", "renderMembers", "toggleAddMember", "submit", "remove", "cancel",
					"allowedToEdit", "addMember", "removeMember");
			...
			isEditable: function (field) {
				...
				switch (field) {
					...
					case "sympliromatikaEggrafaFileList":
						return _.isEqual(self.model.get("candidacies").position.phase.status,
							"ANOIXTI") || _.isEqual(self.model.get("candidacies").position.phase.status, "EPILOGI");
					default:
						break;
				}
				return false;
			...
			render: function (eventName) {
				...
				if (self.model.has("id")) {
					...
					files.fetch({
						cache: false,
						success: function (collection, response) {
							self.addFileEdit(collection, "EKTHESI_AUTOAKSIOLOGISIS",
								self.$("input[name=ekthesiAutoaksiologisisFile]"), {
									withMetadata: true,
									editable: self.isEditable("ekthesiAutoaksiologisisFile")
								});
							self.addFileListEdit(collection, "SYMPLIROMATIKA_EGGRAFA",
								self.$("input[name=sympliromatikaEggrafaFileList]"), {
									withMetadata: true,
